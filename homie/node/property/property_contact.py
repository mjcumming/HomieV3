...
class Property_Contact(Property_Enum):
    ...
    def __init__(self, id='contact', name='Contact', settable=False, retained=False, qos=1, unit=None, data_type='enum', data_format='OPEN,CLOSED', value=None, set_value=None):
